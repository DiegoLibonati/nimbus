...
class TestWeatherInformation:
    ...
    def _make_widget(self, root: tk.Tk, blank_photo: tk.PhotoImage) -> WeatherInformation:
        return WeatherInformation(parent=root, styles=Styles(), img_box=blank_photo)

    def test_instantiation(self, root: tk.Tk, blank_photo: tk.PhotoImage) -> None:
        assert self._make_widget(root, blank_photo) is not None

    def test_is_frame(self, root: tk.Tk, blank_photo: tk.PhotoImage) -> None:
        assert isinstance(self._make_widget(root, blank_photo), tk.Frame)

    def test_wind_text_initialized_empty(self, root: tk.Tk, blank_photo: tk.PhotoImage) -> None:
        assert self._make_widget(root, blank_photo)._wind_text.get() == ""

    def test_wind_value_initialized_empty(self, root: tk.Tk, blank_photo: tk.PhotoImage) -> None:
        assert self._make_widget(root, blank_photo)._wind_value.get() == ""

    def test_humidity_text_initialized_empty(self, root: tk.Tk, blank_photo: tk.PhotoImage) -> None:
        assert self._make_widget(root, blank_photo)._humidity_text.get() == ""

    def test_description_text_initialized_empty(
        self, root: tk.Tk, blank_photo: tk.PhotoImage
    ) -> None:
        assert self._make_widget(root, blank_photo)._description_text.get() == ""

    def test_pressure_text_initialized_empty(self, root: tk.Tk, blank_photo: tk.PhotoImage) -> None:
        assert self._make_widget(root, blank_photo)._pressure_text.get() == ""

    def test_set_values_sets_wind_label(self, root: tk.Tk, blank_photo: tk.PhotoImage) -> None:
        widget = self._make_widget(root, blank_photo)
    ...
    def test_set_values_sets_description_label(
        self, root: tk.Tk, blank_photo: tk.PhotoImage
    ) -> None:
        widget = self._make_widget(root, blank_photo)
        widget.set_values(self._make_parsed())
    ...
    def test_set_values_updates_humidity_value(
        self, root: tk.Tk, blank_photo: tk.PhotoImage
    ) -> None:
        widget = self._make_widget(root, blank_photo)
        widget.set_values(self._make_parsed())
    ...
    def test_set_values_updates_description_value(
        self, root: tk.Tk, blank_photo: tk.PhotoImage
    ) -> None:
        widget = self._make_widget(root, blank_photo)
        widget.set_values(self._make_parsed())
    ...
    def test_set_values_updates_pressure_value(
        self, root: tk.Tk, blank_photo: tk.PhotoImage
    ) -> None:
        widget = self._make_widget(root, blank_photo)
        widget.set_values(self._make_parsed())
